    ...
    <div class="col-md-12 col-xs-12 col-12">
        <div class="card bg-title ">
            <nav class="navbar bg-title">
                <span class="navbar-brand mb-0 h1">Thêm Banner mới</span>
                <a href="{{ route('admin.banner.list') }}" class="btn btn-green-blue my-2 my-sm-0 text-white"><i class="fas fa-undo-alt mr-1 text-white"></i> Quay lại</a>
            </nav>
        </div>
        @if (session('thongbao'))
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <textarea id="description" name="description" style="width: 100%;height: 100px;">{{old('description')}}</textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <img id="avatar" class="thumbnail" width="100%" height="200px" src="{{asset('public/assets/images/import-img.png')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
